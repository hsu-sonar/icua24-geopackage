...
# Import the library function to measure the runtime of find_image_partners.
from image_partners import measure_runtime
...
results_fn_geo50 = benchmark_dir / "image_partners_50_geographic.npy"
db50_cart = benchmark_dir / "benchmark_missions_50_cartesian.gpkg"
results_fn_cart50 = benchmark_dir / "image_partners_50_cartesian.npy"
db500_geo = benchmark_dir / "benchmark_missions_500_geographic.gpkg"
results_fn_geo500 = benchmark_dir / "image_partners_500_geographic.npy"
db500_cart = benchmark_dir / "benchmark_missions_500_cartesian.gpkg"
results_fn_cart500 = benchmark_dir / "image_partners_500_cartesian.npy"
...
for db, fn in all_db:
    ...
    results = measure_runtime(gpkg, 10000, minimum_area=10000)
    np.save(fn, results)
